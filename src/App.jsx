...
export default function App() {
  return (
    <main>
      <Header />
      <ConteudoProduto imgProduto={'./src/img/frigideira.jpg'} nomeProduto={"Frigideira Walita 1200W BT 7.1 QLED Gamer 95BVG-C2"} precoProdutoAvista={2999.99} precoProdutoPrazo={3499.99} precoProdutoParcelas={499.99} notaProduto={"4.0 (⭐⭐⭐⭐)"}/>
